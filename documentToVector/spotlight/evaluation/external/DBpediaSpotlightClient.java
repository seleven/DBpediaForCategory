...
package documentToVector.spotlight.evaluation.external;
...
//        File output = new File("/home/pablo/eval/wikify/systems/Spotlight.list");
        ...
        File input = new File("G:/XExperimentData/Dataset/Pretreatment/Data/webkb/curriculum/5713");
        File output = new File("E:/result.txt");
